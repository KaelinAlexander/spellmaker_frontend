class Reagent {
    ...
    display() {
        ...
        const imgName = this.name.toLowerCase();

        cardImageDiv.innerHTML = `<img class="activator" src="images/reagents/${imgName}.jpg" onerror="this.onerror=null; this.src='images/reagents/Default.jpg'">`
